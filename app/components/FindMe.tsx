...
export default function FindMe() {
  const socialLinks = [
    ...
    {
      name: 'GitHub',
      url: config.contact.social.github,
      icon: (
        <svg className="w-6 h-6 md:w-8 md:h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6 md:w-8 md:h-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      ...
      <Container>
        ...
        <div className="flex justify-center gap-3 md:gap-8 mb-6">
          {socialLinks.map((social) => (
            ...
            >
              <div className="p-2 md:p-4 bg-light-gray rounded-full border-2 border-charcoal group-hover:bg-lime transition-all">
                {social.icon}
              </div>
            </a>
          ))}
